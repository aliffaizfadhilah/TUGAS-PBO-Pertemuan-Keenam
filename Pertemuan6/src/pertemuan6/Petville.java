...
public class Petville extends javax.swing.JFrame {
    ...
    private void DeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DeleteActionPerformed
        ...
        int selectedRow = Petville.getSelectedRow();
        if (selectedRow != -1) {
            // Ambil data dari JTable
            String id_hewan = Petville.getValueAt(selectedRow, 0).toString();
            String nama_hewan = Petville.getValueAt(selectedRow, 1).toString();
            String jenis_hewan = Petville.getValueAt(selectedRow, 2).toString();
            int harga = Integer.parseInt(Petville.getValueAt(selectedRow, 3).toString());
